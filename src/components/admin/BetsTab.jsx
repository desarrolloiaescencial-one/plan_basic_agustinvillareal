          ...
          <div className="flex flex-row sm:flex-col gap-1.5 flex-shrink-0 w-full sm:w-auto">
            ...
            {canReopen && onReopen && (
              <button
                ...
                className="inline-flex items-center justify-center gap-1 px-3 py-1.5 rounded-full font-body font-bold transition-all w-full sm:w-auto"
                style={{
                  fontSize: 11,
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs font-body leading-relaxed" style={{ color: '#5f6e8a' }}>
                  ...
                  Recordá <strong style={{ color: '#0c182b' }}>volver a cerrar</strong> la apuesta cuando los usuarios terminen.
                </p>
              </div>
            </div>
...
export default function BetsTab({ bets, loading, createBet, matches, closeBet, reopenBet, finalizeBet }) {
